...
public class ToadShadeInfoScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.toad_shade_info_screen);
        ...
        menu_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(ToadShadeInfoScreen.this, menu_icon);
    ...
    public void clickImageToToadImageScreen (View view){
        Intent intentForImageToToadImageScreen = new Intent(this, ToadShadeImageScreen.class);
        startActivity(intentForImageToToadImageScreen);
    }
