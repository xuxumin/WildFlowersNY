...
/**
 * Created by xu_xu on 11/28/2016.
 */

public class FlowerLocatorHabitatWoodlandsMoist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.habitat_woodlands_moist);
        ...
        menu_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(FlowerLocatorHabitatWoodlandsMoist.this, menu_icon);
    ...
    public void woodlandMoistClickToToadInfoScreen (View view){
        Intent intentForToadInfoScreen = new Intent(this, ToadShadeInfoScreen.class);
        startActivity(intentForToadInfoScreen);
    }
