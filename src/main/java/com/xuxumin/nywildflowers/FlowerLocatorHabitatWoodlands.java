...
public class FlowerLocatorHabitatWoodlands extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.habitat_woodlands);
        ...
        menu_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(FlowerLocatorHabitatWoodlands.this, menu_icon);
    ...
    public void clickToHabitatWoodlandsMoist (View view){
        Intent intentForWoodlandsMoist = new Intent(this, FlowerLocatorHabitatWoodlandsMoist.class);
        startActivity(intentForWoodlandsMoist);
    }
