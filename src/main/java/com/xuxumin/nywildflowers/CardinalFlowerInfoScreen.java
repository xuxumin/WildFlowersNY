...
public class CardinalFlowerInfoScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cardinal_flower_info_screen);
        ...
        menu_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(CardinalFlowerInfoScreen.this, menu_icon);
