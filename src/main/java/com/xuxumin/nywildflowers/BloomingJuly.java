...
public class BloomingJuly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blooming_july);
        ...
        menu_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(BloomingJuly.this, menu_icon);
    ...
    public void bloomingJulyClickToCardinalFlowerInfoScreen (View view){
        Intent intentForBloomingToCardinalFlower = new Intent(this, CardinalFlowerInfoScreen.class);
        startActivity(intentForBloomingToCardinalFlower);
    }
