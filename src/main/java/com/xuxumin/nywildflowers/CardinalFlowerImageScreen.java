...
public class CardinalFlowerImageScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cardinal_flower_image_screen);
        ...
        menu_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(CardinalFlowerImageScreen.this, menu_icon);
